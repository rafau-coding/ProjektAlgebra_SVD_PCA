...
def run_benchmark(dataset_path):
    ...
    output_csv = 'wyniki_benchmarku_4630_ai.csv'
    ...
    plt.tight_layout()
    plt.savefig('wyniki_wydajnosc_fps_4630_ai.png', dpi=300)
    ...
    plt.tight_layout()
    plt.savefig('wyniki_skutecznosc_detekcji_4630_ai.png', dpi=300)

    print("Utworzono wykresy: 'wyniki_wydajnosc_fps_4630_ai.png' oraz 'wyniki_skutecznosc_detekcji_4630_ai.png'")


if __name__ == "__main__":
    # Możesz tu wpisać dowolną ścieżkę do głównego folderu ze zdjęciami
    DATASET_DIR = "dataset_treningowy_1/AI-Generated Images"
